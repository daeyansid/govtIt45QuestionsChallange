...
guestList.forEach(name => {
    console.log(`Hey ${name}, come to my place at 8 PM sharp to celebrate my TypeScript Journey!`);
});

let moreGuests: string[] = ['Alyaan', 'Hadi', 'Ibad'];
...
console.log("\nRemaining Guests:");
guestList.forEach(name => {
    console.log(`Hey ${name}, you're still invited to dinner!`);
});
